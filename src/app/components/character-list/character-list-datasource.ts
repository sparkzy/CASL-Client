...
const EXAMPLE_DATA: CharacterListItem[] = [
  {id: 1, name: 'Relhaz'},
  {id: 2, name: 'Randy Nitro'},
  {id: 3, name: 'Bahadur'},
  {id: 4, name: 'Da.3'},
  {id: 5, name: 'Kulo'},
  {id: 6, name: 'Poellen Bivex'},
  // {id: 7, name: 'Nitrogen'},
  // {id: 8, name: 'Oxygen'},
  // {id: 9, name: 'Fluorine'},
  // {id: 10, name: 'Neon'},
...
export class CharacterListDataSource extends DataSource<CharacterListItem> {
  data: CharacterListItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<CharacterListItem[]> {
